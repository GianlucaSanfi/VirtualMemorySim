...
Se il bit Invalid è true allora il frame puntato dalla pagina si trova in swap space oppure non è ancora stato caricato => accesso a tale frame genera un page fault. 